...
--
-- Računalo: 127.0.0.1
-- Vrijeme generiranja: Pro 27, 2013 u 01:33 
...
CREATE TABLE IF NOT EXISTS `akcijasustava` (
  ...
  `opisAkcije` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `alat` (
  ...
  `skraceniNaziv` varchar(100) DEFAULT NULL,
  `inacica` varchar(100) DEFAULT NULL,
  `cijena` decimal(9,2) DEFAULT NULL,
  `vidljivost` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ide` (
  ...
  `naziv` varchar(100) DEFAULT NULL,
  `skraceniNaziv` varchar(100) NOT NULL,
  `inacica` varchar(100) DEFAULT NULL,
  `cijena` decimal(9,2) DEFAULT NULL,
  `vidljivost` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idIDE`),
...
CREATE TABLE IF NOT EXISTS `parametar` (
  ...
  `naziv` varchar(100) DEFAULT NULL,
  `ispitniPrimjer` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `rezultat` (
  ...
  `naziv` varchar(100) DEFAULT NULL,
  `iznos` decimal(9,2) DEFAULT NULL,
  `mjernaJedinica` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sklopovlje` (
  ...
  `karakteristika` varchar(100) DEFAULT NULL,
  `skraceniNaziv` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `znanstvenirad` (
  ...
  `sazetak` varchar(100) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `znanstveniskup` (
  ...
  `naziv` varchar(100) DEFAULT NULL,
  `mjesto` varchar(100) DEFAULT NULL,
